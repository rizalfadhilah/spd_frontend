...
.table{
    ...
    box-shadow: 3px 12px 14px -5px rgba(209,190,209,1);
}
.table td, .table th {
...
<div class="container" style="margin-top: 100px">
  <table class="table">
    <h4 class="table" style="font-weight: 500; padding-left: 30px;  padding: 30px; margin-bottom:-10px ;">GENERAL ACCOUNT SETTING</h4>
    
    <div class="row table" style="padding: 30px; margin-left: 0px; margin-bottom: 0px">
      <div class="col-md-3">
          <p style="color: black; font-size: 18px; font-weight: bold;">Name</p>
        </div>
        <div class="col-md-4">
          First Name :<input type="text" id="dropdownku" class="btn" name="">
        </div>
        <div class="col-md-4">
          Last Name :<input type="text" id="dropdownku" class="btn" name="">
        </div>
        <div class="col-md-3"></div>
        <div class="col-md-6">
          <br>
          <button class="btn btn-primary" style="background-color: black; margin: 0px"><a href="#" style="padding: 20px; font-size: 18px; color: white; text-transform: none;">Save Change</a></button> <button class="btn btn-primary" style="background-color: #8a8a8a; margin: 0px"><a href="#" style="padding: 20px; font-size: 18px; color: white; text-transform: none;">Cancel</a></button>
        </div>
    </div>

    
       <tr>
        <td id="dualima"><b>Username</b></td>
        <td id="dualima">Jhonny</td>
        <td id="limapuluh"><a href="#">Edit</a></td>
      </tr>
      <tr>
        <td id="dualima"><b>Contact</b></td>
        <td id="dualima">Jhondoe@gmail.com</td>
        <td id="limapuluh"><a href="#">Edit</a></td>
      </tr>
      <tr>
        <td id="dualima"><b>Second Contact</b></td>
        <td id="dualima">Jhondoe@yahoo.com</td>
        <td id="limapuluh"><a href="#">Edit</a></td>
      </tr>
      <tr>
        <td id="dualima"><b>Password</b></td>
        <td id="dualima">********</td>
        <td id="limapuluh"><a href="#">Edit</a></td>
      </tr>
      <tr>
        <td id="dualima"><b>Security</b></td>
        <td id="dualima">Questions</td>
        <td id="limapuluh"><a href="#">Edit</a></td>
      </tr>
      <tr>
        <td id="dualima"><b>Privacy</b></td>
        <td id="dualima">Public</td>
        <td id="limapuluh"><a href="#">Edit</a></td>
      </tr>
      <tr>
        <td id="dualima"><b>Languange</b></td>
        <td id="dualima">English</td>
        <td id="limapuluh"><a href="#">Edit</a></td>
      </tr>
      <tr>
        <td id="dualima"><b>Blocking</b></td>
        <td id="dualima">Blocked 1 member</td>
        <td id="limapuluh"><a href="#">Edit</a></td>
      </tr>
    </table>
</div>
   ...
   <!-- start footer -->
              ...
              <div class="container-fluid" style="background-image: url('images/footer_bg.png'); padding: 0px; margin: 0px; padding-top: 100px; padding-bottom: 100px; margin-top: 150px;">
