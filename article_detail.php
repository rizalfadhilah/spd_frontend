...
<div class="container-fluid" style="margin-top: 100px">
  <center><h1 style="font-weight: 500;">ARTICLE TITLE</h1>
  </center>
  <a href="#"><h6 style="margin-left: 20px"><i class="fa fa-angle-left"></i> BACK</h6></a>
</div>  

<div class="container">
  <img src="images/mobil1.PNG" class="img-responsive" style="width: 100%">
  <br>
  <p style="padding: 50px; font-size: 20px">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
...
<section class="section4" style="background-color:black;">
    ...
    <div class="spe-cor">
      <div class="container">
        <h1 style="color: white; padding-top: 100px; margin-bottom: -150px">SEE OTHER ARTICLES</h1>
                ...
                <div class="carousel-item active">
                  <div class="col-md-4 col-sm-4 col-4" style="margin: 0px; padding: 0px;">
                    ...
                    <div id="article-detail">
                      <h4 style="font-size: 25px; color: white;">Lorem Ipsum</h4>
