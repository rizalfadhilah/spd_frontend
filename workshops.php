...
#kanan{
    margin-top: -131px;
    margin-left: 52px;
    box-shadow: 3px 0px 16px -4px rgba(173,171,173,1);
}
...
<div style="margin-top: 55px">
  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126931.61746107008!2d106.8080557329998!3d-6.182514509650787!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3e945e34b9d%3A0x5371bf0fdad786a2!2sJakarta!5e0!3m2!1sen!2sid!4v1573653150721!5m2!1sen!2sid" width="100%" height="500" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-6" style="margin-top: -57px">
      ...
      <nav class="navbar navbar-expand-sm" style="background-color: transparent;">
        ...
        <ul class="navbar-nav">
          ...
          <li>
            <div class="dropdown">
              <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" style="background-color: #171717; color: white; border: none; padding-left: 50px; padding-right: 50px; border-radius: 0px; padding-top:10px; padding-bottom: 10px ">
                Distance
              </button>
          ...
          <li>
           <div class="dropdown">
            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" style="background-color: #8a8a8a; color: white; border: none; padding-left: 50px; padding-right: 50px; border-radius: 0px; padding-top:10px; padding-bottom: 10px ">
              Car Make
            </button>
            <div class="dropdown-menu">
              <a class="dropdown-item" href="#">Link 1</a>
    ...
    <div class="dropdown">
            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" style="background-color: #ffffff;box-shadow: 3px 0px 16px -4px rgba(173,171,173,1); border: none;padding-left: 50px;padding-right: 50px;border-radius: 0px;padding-top: 10px;padding-bottom: 10px;margin-left: 16px;
    margin-top: -8px;width: 359px;font-weight: bold; color: black;text-align: left;">
              Type of service
            </button>
            <div class="dropdown-menu">
              <a class="dropdown-item" href="#">Link 1</a>
...
<div class="container-fluid">
 <div class="row">
    <div class="col-sm-8"> 
      ...
      <div class="row" style="background-color: white; padding: 20px; margin: 0px; padding-bottom: 100px; box-shadow: 3px 0px 16px -4px rgba(173,171,173,1); ">
        <div class="col-md-8">
          <h5><b>GARAGE A</b></h5>
          <p>
          <b>Address: </b> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
          tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam <br>
          <b>Hours: </b> Open, Closes 9PM <br>
          <b>Phone: </b> (021) 123 456 789 <br>
          <b>Service: </b> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
          tempor incididunt ut labore et dolore magna aliqua.
        </p>
        </div>
        <div class="col-md-4">
          <h5 style="background-color: black; color: white; float: right; padding: 5px 15px 5px 15px;">4.8</h5> <br><br>
          <p style="float: right; margin-right: -64px;">300 reviews</p> <br><br><br><br><br><br>
          <button class="btn btn-default" style="background-color: black; float: right; z-index: 2">
          <a href="#" style="padding-left: 10px; padding-right: 10px; font-size: 14px; color: white; text-transform: capitalize;">Write reviews</a>
        </button>

        </div>

    </div>
    <div class="row" style="margin-top: -253px;margin-left: 20px; margin-bottom: 50px">
          ...
          <div id="slider-2" class="carousel carousel-by-item slide" data-ride="carousel" data-interval="false" >
            <div  class="carousel-inner" role="listbox">
              ...
              <div class="carousel-item active">
                <div class="col-md-3 col-sm-3 col-3" style="margin: 0px; padding: 0px;">
                  <img class="d-block img-fluid" style="width: 100%; height: auto; padding: 2px" src="images/jonathan-gallegos-725084-unsplash.png" alt="First slide">
              ...
              <div id="padding-between-content1" class="carousel-item">
                <div class="col-md-3 col-sm-3 col-3" style="margin: 0px; padding: 0px;">
                  <img class="d-block img-fluid" style="width: 100%; height: auto; padding: 2px" src="images/severin-d-370303-unsplash.png" alt="First slide">
              ...
              <div id="padding-between-content2" class="carousel-item">
                <div class="col-md-3 col-sm-3 col-3" style="margin: 0px; padding: 0px;">
                  <img class="d-block img-fluid" style="width: 100%; height: auto; padding: 2px" src="images/serge-kutuzov-223327-unsplash.png" alt="First slide">
        ...
        <div class="col-md-2">
           <a id="custom-slider1" class="carousel-control-prev" href="#slider-2" role="button" data-slide="prev">
            <img src="images/Group_4-1.png" id="kiri">
          </a>
          <a id="custom-slider1" class="carousel-control-prev" href="#slider-2" role="button" data-slide="prev">
            <img src="images/Group_4-1.png" id="kiri">
          </a>
          ...
          <a id="custom-slider2" class="carousel-control-next" href="#slider-2" role="button" data-slide="next">
            <img src="images/Group_4.png" id="kanan">
          </a>
          <a id="custom-slider2" class="carousel-control-next" href="#slider-2" role="button" data-slide="next">
            <img src="images/Group_4.png" id="kanan">
          </a>
    ...
    <div class="row" style="margin-top: -253px;margin-left: 20px; margin-bottom:50px">
        ...
        <div class="col-md-10">
          <div id="slider-3" class="carousel carousel-by-item slide" data-ride="carousel" data-interval="false" >
            <div  class="carousel-inner" role="listbox">
        ...
        <div class="col-md-2">
           <a id="custom-slider1" class="carousel-control-prev" href="#slider-3" role="button" data-slide="prev">
            <img src="images/Group_4-1.png" id="kiri">
          </a>
          <a id="custom-slider1" class="carousel-control-prev" href="#slider-3" role="button" data-slide="prev">
            <img src="images/Group_4-1.png" id="kiri">
          ...
          <a id="custom-slider2" class="carousel-control-next" href="#slider-3" role="button" data-slide="next">
            <img src="images/Group_4.png" id="kanan">
          </a>
          <a id="custom-slider2" class="carousel-control-next" href="#slider-3" role="button" data-slide="next">
            <img src="images/Group_4.png" id="kanan">
      ...
      <div class="row" style="background-color: white; padding: 20px; margin-top: 50px;  margin: 0px; padding-bottom: 100px; box-shadow: 3px 0px 16px -4px rgba(173,171,173,1); ">
        <div class="col-md-8">
          <h5><b>GARAGE C</b></h5>
          <p>
          <b>Address: </b> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
    ...
    <div class="row" style="margin-top: -253px;margin-left: 20px; margin-bottom:50px">
        ...
        <div class="col-md-10">
          <div id="slider-4" class="carousel carousel-by-item slide" data-ride="carousel" data-interval="false" >
            <div  class="carousel-inner" role="listbox">
        ...
        <div class="col-md-2">
           <a id="custom-slider1" class="carousel-control-prev" href="#slider-4" role="button" data-slide="prev">
            <img src="images/Group_4-1.png" id="kiri">
          </a>
          <a id="custom-slider1" class="carousel-control-prev" href="#slider-4" role="button" data-slide="prev">
            <img src="images/Group_4-1.png" id="kiri">
          ...
          <a id="custom-slider2" class="carousel-control-next" href="#slider-4" role="button" data-slide="next">
            <img src="images/Group_4.png" id="kanan">
          </a>
          <a id="custom-slider2" class="carousel-control-next" href="#slider-4" role="button" data-slide="next">
            <img src="images/Group_4.png" id="kanan">
      ...
      <button class="btn btn-default" style="background-color: black; margin-left: 35px; margin-bottom: 100px">
          <a href="#" style="padding-left: 50px; padding-right: 50px; font-size: 20px; color: white;">VIEW MORE</a>
        </button>
    ...
    <div class="col-sm-4">
      <div style="background-color: white; padding: 20px;box-shadow: 3px 0px 16px -4px rgba(173,171,173,1); ">
    <h5><b>CHECK OTHER GARAGES</b></h5>
  ...
  <div style="background-color: white; padding: 20px; margin-top: 20px;box-shadow: 3px 0px 16px -4px rgba(173,171,173,1); ">
    <h5><b>TOP MEMBERS OF THE WEEK</b></h5>
    
    <div class="row" style="margin-top: 10px">
      <div class="col-md-4">
        <img style="max-width: 100%; border-radius: 100px" src="https://www.aceshowbiz.com/images/photo/the_rock.jpg">
      </div>
      <div class="col-md-8">
        <b>LOREM IPSUM</b>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing eli</p>
        <button class="btn btn-default" style="background-color: black; float: right;">
          <a href="#" style="padding-left: 15px; padding-right: 15px; font-size: 14px; color: white; text-transform: capitalize;">Follow</a>
        </button> 
      </div>
    </div>
    <hr>
...
<section class="section4" style="background-color:black; display: none;">
        ...
        <div class="col-md-10">
          <div id="slider-2" class="carousel carousel-by-item slide" data-ride="carousel">
            <div  class="carousel-inner" role="listbox">
              ...
              <div class="carousel-item active">
                <div class="col-md-3 col-sm-3 col-3" style="margin: 0px; padding: 0px;">
                  <img class="d-block img-fluid" style="width: 100%; height: auto; padding: 4px" src="images/jonathan-gallegos-725084-unsplash.png" alt="First slide">
              ...
              <div id="padding-between-content1" class="carousel-item">
                <div class="col-md-3 col-sm-3 col-3" style="margin: 0px; padding: 0px;">
                  <img class="d-block img-fluid" style="width: 100%; height: auto; padding: 4px" src="images/severin-d-370303-unsplash.png" alt="First slide">
              ...
              <div id="padding-between-content2" class="carousel-item">
                <div class="col-md-3 col-sm-3 col-3" style="margin: 0px; padding: 0px;">
                  <img class="d-block img-fluid" style="width: 100%; height: auto; padding: 4px" src="images/serge-kutuzov-223327-unsplash.png" alt="First slide">
...
<div class="container-fluid" style="background-image: url('images/footer_bg.png'); padding: 0px; margin: 0px; padding-top: 100px; padding-bottom: 100px; margin-top: 50px;">
...
$(document).ready(function() {
  ...
  var item_1 = '#slider-4 .carousel-item';
  var item_inner_1 = "#slider-4 .carousel-inner";
  classes = GetUnique(item_1);
  setcss(classes, item_1, item_inner_1);
});
</script>
