...
<div class="container-fluid" style="margin-top: 50px; margin-bottom: 50px">
            <div class="row">
                ...
                <div id="section1-option1" class="col-md-4 col-lg-4 col-xs-4 col-sm-4">
                    <a href="#">
                        <h4 class="section1-title">CAR</h4>
                    </a>
                </div>
                ...
                <div id="section1-option2" class="col-md-4 col-lg-4 col-xs-4 col-sm-4">
                    <a href="#">
                         <h4 class="section1-title">CLUBS</h4>
                    </a>
                </div>
                ...
                <div id="section1-option3" class="col-md-4 col-lg-4 col-xs-4 col-sm-4">
                    <a href="#">
                        <h4 class="section1-title">MEMBERS</h4>
                    </a>
                </div>
    ...
    <div class="col-sm-8"> 
      ...
      <div class="row" style="background-color: white; padding: 20px; margin: 0px; padding-bottom: 100px; box-shadow: 3px 0px 16px -4px rgba(173,171,173,1); ">
        ...
        <div class="col-md-2">
          ...
          <a href="#" style="padding-left: 15px; padding-right: 15px; font-size: 17px; color: white; text-transform: capitalize;">Follow</a>
        </button>
