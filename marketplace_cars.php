...
<style id='bp-legacy-css-inline-css' type='text/css'>
    ...
    #dropdownku{
      ...
      padding: 10px;
      border-color: white;
      box-shadow: 3px -1px 11px -2px rgba(0, 0, 0, 0.53)
    }
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="dropdown">
                      <button type="button" class="btn btn-primary dropdown-toggle" id="dropdownku" data-toggle="dropdown">
                        PARTS
                      </button>
                    ...
                    <h5 class="sortby">PERFORMANCE UPGRADES:</h5>
                    ...
                    <h5 class="sortby">SUB CATEGORY:</h5>
                    ...
                    <br>
                    <h5 class="sortby">OTHER UPGRADES:</h5>
                    <div class="dropdown">
                      <button type="button" class="btn btn-primary dropdown-toggle" id="dropdownku" data-toggle="dropdown">
                        NEW
                      </button>
                    ...
                    <div class="dropdown">
                      ...
                      <br>
                        <button class="btn btn-primary" style="background-color: black;">
                         <a href="#" style="padding: 20px; font-size: 20px; color: white;">APPLY</a>
                        </button> 
                    </div>
                ...
                <div class="col-md-8">
                        <div id="search-result-featured" class="card">
                                <img class="card-img-top" src="images/robin-vet-219446-unsplash.png" alt="Card image cap">
                                <div class="card-body">  
                        ...
                        <div class="row">
                                ...
                                <div  class="col-md-4">
                                        <div  id="search-results" class="card">
                                            <img class="card-img-top" src="images/marcus-p-655824-unsplash.png" alt="Card image cap">
                                            <div class="card-body">
                                              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                            </div>
                                        </div>
                      ...
                      <center>
                        <div>
                        <button class="btn btn-primary" style="background-color: black; width: 40%"><a href="#" style="padding: 20px; font-size: 20px; color: white;">VIEW MORE</a></button> 
                        </div>
                      </center>
