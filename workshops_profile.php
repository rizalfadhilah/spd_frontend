  ...
  <ul class="navbar-nav ml-auto ">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item avatar dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg-right dropdown-secondary" aria-labelledby="navbarDropdownMenuLink-5" style="background-color: black; padding: 10px; border-radius: 0px; width: 400px">
              <p style="color: white; border-bottom: 1px white solid; font-size: 14px">Friend Request</p>

              <ul>
                <li>
                  <a href="#" class="d-flex align-items-center"><img style="width: 50px; height: 50px; border-radius: 100px;" src="http://www.innoarea.com/wp-content/uploads/2012/09/john-doe.jpg" class="max-w-40 mr-20">
                    <div class="d-flex flex-column" style="padding: 15px">
                      <p style="color: white" class="label text-content-grey"><b>Jhon Doe </b> sent you a friend request</p>
                    </div>
                    <!-- <img style="width: 50px; height: 50px" src="https://amp.businessinsider.com/images/592f4169b74af41b008b5977-750-563.jpg" class="max-w-40 mr-20"> -->
                  </a>
                </li>
                <li>
                  <a href="#" class="d-flex align-items-center"><img style="width: 50px; height: 50px; border-radius: 100px;" src="http://www.innoarea.com/wp-content/uploads/2012/09/john-doe.jpg" class="max-w-40 mr-20">
                    <div class="d-flex flex-column" style="padding: 15px">
                      <p style="color: white" class="label text-content-grey"><b>Jhon Doe </b> add new pictures</p>
                    </div>
                    <img style="width: 50px; height: 50px" src="https://amp.businessinsider.com/images/592f4169b74af41b008b5977-750-563.jpg" class="max-w-40 mr-20">
                  </a>
                </li>
...
<div class="container-fluid" style="margin: 0px; padding: 0px">
  <img src="images/nissan2.jpg" style="width: 100%">
</div>
...
<div class="container-fluid">
 <div class="row">
    <div class="col-sm-8"> 
          <div class="row" style="margin-top: -302px; margin-left: 20px; margin-bottom: 50px; ">
        ...
        <div class="col-md-2">
           <a id="custom-slider1" class="carousel-control-prev" href="#slider-2" role="button" data-slide="prev">
            <img src="images/Group_4.png" id="kiri">
          </a>
          <a id="custom-slider1" class="carousel-control-prev" href="#slider-2" role="button" data-slide="prev">
            <img src="images/Group_4.png" id="kiri">
          </a>
          ...
          <a id="custom-slider2" class="carousel-control-next" href="#slider-2" role="button" data-slide="next">
            <img src="images/Group_4-1.png" id="kanan">
          </a>
          <a id="custom-slider2" class="carousel-control-next" href="#slider-2" role="button" data-slide="next">
            <img src="images/Group_4-1.png" id="kanan">
          </a>
      ...
      <div class="row" style="background-color: white; padding: 20px; margin: 0px; padding-bottom: 100px;padding-top: 200px;    margin-top: -172px; box-shadow: 3px 0px 16px -4px rgba(173,171,173,1); ">
        <div class="col-md-8">
          <h5><b>GARAGE A</b></h5>
          <p>
          ...
          <tr>  
              <td></td>
              <td>Mon : 10.00 am - 18.00 pm</td>
          </tr>
          <tr>  
              <td></td>
              <td>Tues : 10.00 am - 18.00 pm</td>
          </tr>
          <tr>  
              <td></td>
              <td>Wed : 10.00 am - 18.00 pm</td>
          </tr>
          <tr>  
              <td></td>
              <td>Thurs : 10.00 am - 18.00 pm</td>
          </tr>
          <tr>  
              <td></td>
              <td>Fri : 10.00 am - 18.00 pm</td>
          </tr>
          <tr>  
              <td></td>
              <td>Sat : 10.00 am - 18.00 pm</td>
          </tr>
          <tr>  
              <td></td>
              <td>Sun : Close</td>
        ...
        <div class="col-md-4">
          ...
          <div class="col-md-12" style="margin-bottom: 100px; border-bottom: 1px #333 solid; padding-bottom: 50px ">
             <input type="text" class="form-control" name="" placeholder="Write a comment" style="text-transform: none;border-radius: 0px; box-shadow: 4px 3px 7px -3px rgba(173,171,173,1);">

            <button class="btn btn-default" style="margin-top: 15px;background-color: black; color: white; border-radius: 0px; float: right; padding-left: 70px; padding-right: 70px;">Submit</button>
          ...
          <div class="row">
          <div class="col-md-2">
            <img style="max-width: 100%; border-radius: 200px" src="https://www.aceshowbiz.com/images/photo/the_rock.jpg">
          </div>
          <div class="col-md-10">
            <h5><b>Jhon Doe</b></h5>
            <button class="btn btn-default" style="background-color: black; float: right;">
              <a href="#" style="font-size: 14px; color: white; text-transform: capitalize;">Follow</a>
            </button> 
